---
description: Run the PortfolioAtlas agentic blog post pipeline (data -> plan -> write -> humanize -> inject -> fact-check -> charts/QA) with review gates. Never deploys.
